...
export const ar = {
  ...
  dq_subtitle: 'السجلات التي تناقض نفسها أو ينقصها ما يجب أن تحمله.',
  dq_severity_contradiction: 'تناقضات',
  dq_severity_gap: 'نواقص',
  dq_severity_all: 'كل الملاحظات',
  dq_summary_note: 'لا تؤثر أي ملاحظة هنا على قرار الفحص الميداني. هذه الصفحة عن دقة السجلات، لا عمّن يُسمح له بالعمل اليوم.',
  dq_all_clear: 'لا توجد ملاحظات. كل السجلات متسقة داخليًا.',
  dq_none_in_filter: 'لا شيء في هذه الفئة.',
  dq_no_modules: 'ليس لديك صلاحية عرض أي وحدة بعد.',
  dq_load_failed: 'تعذّر تحميل الملاحظات.',
  dq_retry: 'إعادة المحاولة',
  dq_show_all: 'عرض {count} أخرى',
  dq_show_fewer: 'عرض أقل',
  dq_patterns_title: 'الفحوص الطبية المعلّمة كغير مطلوبة، حسب المسمى الوظيفي ({count})',
  dq_patterns_note: 'ليست ملاحظة — لا تستطيع المنصة تحديد ما إذا كان التعليم صحيحًا. تُعرض لتلاحظ أي مسمى يبدو خاطئًا.',
