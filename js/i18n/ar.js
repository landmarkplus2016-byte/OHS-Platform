...
export const ar = {
  ...
  dq_severity_contradiction: 'تناقض',
  dq_search_placeholder: '…ابحث بالاسم أو الرقم',
  dq_filter_severity: 'الدرجة',
  dq_filter_check: 'نوع الملاحظة',
  dq_filter_all_checks: 'كل الأنواع',
  dq_fix: 'تصحيح',
  dq_col_record: 'السجل',
  dq_col_severity: 'الدرجة',
  dq_col_issue: 'الملاحظة',
  dq_col_detail: 'التفصيل',
  dq_col_title: 'المسمى الوظيفي',
  dq_col_count: 'العدد',
  dq_severity_gap: 'نقص',
  dq_all_clear: 'لا توجد ملاحظات. كل السجلات متسقة داخليًا.',
  dq_no_modules: 'ليس لديك صلاحية عرض أي وحدة بعد.',
  dq_patterns_title: 'الفحوص الطبية المعلّمة كغير مطلوبة، حسب المسمى الوظيفي ({count})',
  dq_patterns_note: 'ليست ملاحظة — لا تستطيع المنصة تحديد ما إذا كان التعليم صحيحًا. افتح أي مسمى وظيفي لترى مَن هم وتحكم بنفسك.',
  dq_patterns_note_flat: 'ليست ملاحظة — لا تستطيع المنصة تحديد ما إذا كان التعليم صحيحًا. تُعرض لتلاحظ أي مسمى يبدو خاطئًا.',

  // Check names
  dq_check_cert_na_and_suspended: 'الشهادة معلّمة كغير مطلوبة وموقوفة معًا',
  dq_check_archived_status_drift: 'مؤرشف، لكن حالة التوظيف لا تقول إنه غادر',
  dq_check_status_archive_drift: 'حالة التوظيف تقول إنه غادر، لكن السجل غير مؤرشف',
  dq_check_national_id_malformed: 'الرقم القومي ليس ١٤ رقمًا',
  dq_check_hire_date_implausible: 'تاريخ التعيين ليس تاريخًا حقيقيًا',
  dq_check_wah_practical_without_mcu: 'شهادة العمل على ارتفاع العملية بدون فحص طبي',
  dq_check_cert_blank_not_na: 'الشهادة بدون تاريخ وغير معلّمة كغير مطلوبة',
  dq_check_hire_date_missing: 'لا يوجد تاريخ تعيين',
  dq_check_legal_permission_missing: 'لا يوجد إذن قانوني مسجّل',
  dq_check_equipment_no_subcontractor: 'لا توجد شركة مالكة مسجّلة',
  dq_check_equipment_no_third_party: 'لا يوجد تاريخ فحص طرف ثالث',
  dq_check_wave_pending_stale: 'فحص بانتظار المراجعة',

  // Why each check matters
  dq_why_cert_na_and_suspended: 'كلا العلامتين مفعّلة. «غير مطلوبة» هي الغالبة، فتظهر الشهادة كغير مطلوبة — لكن إحدى العلامتين خطأ.',
  dq_why_archived_status_drift: 'السجل موجود في المستقيلين والمنهية خدماتهم بينما لا يزال مصنّفًا نشطًا. تلك الصفحة تعرض ملخص الشهادات لا الحالة، فلا يظهر هذا من القائمة.',
  dq_why_status_archive_drift: 'الموظف مسجّل كمن غادر لكنه لا يزال في قائمة الفريق. إما أن تؤرشفه، أو أن الحالة سُجّلت قبل يوم عمله الأخير.',
  dq_why_national_id_malformed: 'الرقم القومي المصري ١٤ رقمًا. أي طول آخر هو غالبًا رقم ناقص أو مكرر أثناء الاستيراد.',
  dq_why_hire_date_implausible: 'التاريخ الذي يُقرأ كرقم بدل تاريخ ينتهي في ١٩٠٥. كما يجعل أي حساب لمدة الخدمة خاطئًا.',
  dq_why_wah_practical_without_mcu: 'سُجّل هذا الموظف كمدرَّب على العمل على ارتفاع بينما لا يوجد فحص طبي في الملف. الفحص الطبي شرط مسبق للصعود.',
  dq_why_cert_blank_not_na: 'لا تاريخ مسجّل وغير معلّمة كغير مطلوبة — فتقرأها المنصة كـ«يجب أن تكون موجودة وليست كذلك». إما أن تُدخل التاريخ أو تعلّمها كغير مطلوبة.',
  dq_why_hire_date_missing: 'بدون تاريخ تعيين يخرج الموظف بصمت من مجموعة اختبار المخدرات، دون أن يظهر في عدد المستبعدين.',
  dq_why_legal_permission_missing: 'الإذن القانوني فارغ، فيمنع قرار الفحص الميداني هذا الموظف بسبب حقل لم يملأه أحد.',
  dq_why_equipment_no_subcontractor: 'أُضيفت الشركة المالكة إلى المخطط بعد تسجيل هذه المعدة. بدونها لا إجابة لسؤال «لمن هذه المعدة».',
  dq_why_equipment_no_third_party: 'لا يوجد إثبات فحص طرف ثالث، فتحمل المعدة تحذيرًا دائمًا لا يمكن إزالته.',
  dq_why_wave_pending_stale: 'سجّل مسؤول السلامة هذا الفحص ولم يبتّ فيه أي مشرف. الفحص الناجح المعلّق لا يُحتسب، فلم تُعتمد المعدة بناءً عليه.',

  // Finding text
  dq_cert_na_and_suspended: '{cert} معلّمة كغير مطلوبة وموقوفة معًا',
  dq_archived_status_drift: 'مؤرشف، لكن الحالة لا تزال «{status}»',
  dq_status_archive_drift: 'الحالة «{status}» لكن السجل غير مؤرشف',
  dq_national_id_malformed: 'الرقم القومي يحتوي {length} رقمًا بدل ١٤',
  dq_hire_date_implausible: 'تاريخ التعيين مسجّل {date}',
  dq_wah_practical_without_mcu: 'الشهادة العملية سارية حتى {expiry}، ولا فحص طبي مسجّل',
  dq_cert_blank_not_na: '{cert} بدون تاريخ انتهاء وغير معلّمة كغير مطلوبة',
  dq_hire_date_missing: 'لا يوجد تاريخ تعيين مسجّل',
  dq_legal_permission_missing: 'لا يوجد إذن قانوني مسجّل',
  dq_equipment_no_subcontractor: 'لا توجد شركة مالكة مسجّلة',
  dq_equipment_no_third_party: 'لا يوجد تاريخ فحص طرف ثالث مسجّل',
  dq_wave_pending_stale: 'فحص بتاريخ {date} انتظر المراجعة {days} يومًا',
  nav_more: 'المزيد',
  nav_menu: 'التنقل',
  close: 'إغلاق',
  ...
  export_report: 'تقرير',
  export_report_desc: 'ورقة ملخّص مع السجلات، بعد حذف الأعمدة الداخلية. للإدارة والعملاء.',
  export_excel: 'إكسل',
  ...
  export_caps_note: 'حد PDF هو {pdf} سجل، وحد كل صيغ الجداول هو {spreadsheet}.',

  export_sheet_dashboard: 'الملخّص',
  export_report_title: 'تقرير التزام {module}',
  export_report_company: 'الشركة',
  export_report_generated: 'تاريخ الإصدار',
  export_report_filters: 'الفلاتر المطبَّقة',
  export_report_no_filters: 'لا شيء — المجموعة كاملة',
  export_report_total: 'عدد السجلات في هذا التقرير',
  export_dash_verdict: 'القرار',
  export_dash_state: 'الحالة',
  export_dash_count: 'العدد',
  export_dash_share: 'النسبة %',
  export_dash_worst_state: 'الموظفون حسب أسوأ حالة شهادة',
  export_dash_by_cert: 'الشهادات حسب الحالة',
  export_dash_certificate: 'الشهادة',
  export_dash_by_subcontractor: 'العدد حسب مقاول الباطن',
  export_dash_by_team: 'العدد حسب الفريق',
  export_dash_third_party: 'حالة فحص الطرف الثالث',
  export_dash_by_item: 'المعدات حسب نوع الصنف',
  export_dash_by_owner: 'المعدات حسب الشركة المالكة',
  export_dash_not_recorded: 'غير مسجَّل',
