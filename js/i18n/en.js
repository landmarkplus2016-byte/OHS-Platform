...
export const en = {
  ...
  dq_severity_contradiction: 'Contradiction',
  dq_search_placeholder: 'Search by name or ID…',
  dq_filter_severity: 'Severity',
  dq_filter_check: 'Issue type',
  dq_filter_all_checks: 'All issue types',
  dq_fix: 'Fix',
  dq_col_record: 'Record',
  dq_col_severity: 'Severity',
  dq_col_issue: 'Issue',
  dq_col_detail: 'Detail',
  dq_col_title: 'Job title',
  dq_col_count: 'Count',
  dq_severity_gap: 'Gap',
  ...
  export_report_desc: 'A Dashboard summary plus the records, with internal columns removed. For management and customers.',
  export_excel: 'Excel',
  ...
  export_caps_note: 'PDF is capped at {pdf} records; every spreadsheet format at {spreadsheet}.',

  export_sheet_dashboard: 'Dashboard',
  export_report_title: '{module} compliance report',
  export_report_company: 'Company',
  export_report_generated: 'Generated',
  export_report_filters: 'Filters applied',
  export_report_no_filters: 'None — the full set',
  export_report_total: 'Records in this report',
  export_dash_verdict: 'Verdict',
  export_dash_state: 'State',
  export_dash_count: 'Count',
  export_dash_share: 'Share %',
  export_dash_worst_state: 'Employees by worst certificate state',
  export_dash_by_cert: 'Certificates by status',
  export_dash_certificate: 'Certificate',
  export_dash_by_subcontractor: 'Headcount by subcontractor',
  export_dash_by_team: 'Headcount by team',
  export_dash_third_party: 'Third-party inspection status',
  export_dash_by_item: 'Equipment by item type',
  export_dash_by_owner: 'Equipment by owning company',
  export_dash_not_recorded: 'Not recorded',
